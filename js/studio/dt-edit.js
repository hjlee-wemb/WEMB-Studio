...
(function initDTEdit() {
  ...
  const DTSEL = '.dt-bname, .dt-nav a, .dt-navbtn span, .dt-sym span, .dt-cardhead h3, .dt-tabs b, .dt-live, .dt-chip, .dt-tnm, .skxp-txt, .skh-root p, .skv-root p, .pkm-root p, .pka-root p, .pko-root p, .pkr-root p, .pkf-root p, .pkd-root p, .pks1-root p, .lsm-root p, .lsd-root p, .hjc-root p, .hjg-root p, .hju-root p, .hno2-root p, .hnc1-root p, .hnc2-root p, .hnm-root p, .hni1-root p, .hni2-root p, .hne-root p, .hnn1-root p, .hnn2-root p, .hnn3-root p, .hnf-root p, .hns1-root p, .hns2-root p, .hnl-root p';
