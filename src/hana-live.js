/* 한진 SMART 통합관제 — 재구축 화면 3장의 인터랙션·라이브 데이터 레이어
   대상: src/hana-control.js(hn) · hana-gate.js(hn) · hana-unload.js(hn)
   ...
   window.initHana(root)  — 화면 하나를 살린다(여러 번 불러도 안전)
   window.disposeHana(root) — 타이머·리스너 정리 */
(function () {
  'use strict';

  /* ══════════════════ 0. 공통 스타일 ══════════════════
     주의: 화면 CSS 의 리셋이 `.hnX-root *`(특이도 0,1,0)라 여기서는 최소 0,2,0 이상으로 건다. */
  var STYLE_ID = 'hana-live-style';
  var CSS = [
    /* 호버 틴트 — 레이아웃·자식에 영향을 주지 않도록 ::before 오버레이로만 칠한다
       (conv.js 는 ::after 만 쓰므로 ::before 는 비어 있다) */
    '.hn-root .hn-hot{cursor:pointer;}',
    '.hn-root .hn-hot::before{content:"";position:absolute;inset:0;border-radius:inherit;',
    'background:#ffffff;opacity:0;pointer-events:none;transition:opacity .18s ease;z-index:2;}',
    '.hn-root .hn-hot:hover::before{opacity:.10;}',
    '.hn-root .hn-hot:active::before{opacity:.17;transition-duration:.06s;}',
    '.hn-root[data-theme="light"] .hn-hot::before{background:#1b2a4a;}',
    '.hn-root[data-theme="light"] .hn-hot:hover::before{opacity:.075;}',
    '.hn-root[data-theme="light"] .hn-hot:active::before{opacity:.13;}',
    /* 표의 행은 살짝만 — 글자가 많아 강한 틴트는 읽기를 방해한다 */
    '.hn-root .hn-hot.hn-row:hover::before{opacity:.055;}',
    '.hn-root[data-theme="light"] .hn-hot.hn-row:hover::before{opacity:.045;}',
    /* 선택 가능한 묶음은 상태가 바뀔 때 색·테두리가 부드럽게 넘어가도록 */
    '.hn-root .hn-swap{transition:background-color .22s ease,border-color .22s ease,color .22s ease,box-shadow .22s ease;}',
    '.hn-root .hn-swap p{transition:color .22s ease;}',
    /* 이벤트 현황 패널 — 규칙은 아래 '이 시안' 묶음에 있다(재서 정한 --hn-lift). */
    '.hn-root .hn-foldbtn{transition:transform .42s cubic-bezier(.22,.9,.24,1);}',
    '.hn-root .hn-foldbtn.hn-open{transform:rotate(180deg);}',
    /* 라이브 수치 — 값이 바뀔 때 아주 짧게 밝아졌다 돌아온다(깜빡임이 아니라 숨결) */
    '.hn-root .hn-tick{animation:hnTick .5s ease-out;}',
    '@keyframes hnTick{0%{filter:brightness(1.9)}100%{filter:brightness(1)}}',
    '.hn-root[data-theme="light"] .hn-tick{animation-name:hnTickL;}',
    '@keyframes hnTickL{0%{filter:brightness(.55)}100%{filter:brightness(1)}}',
    /* 차트 전환 — 실시간 데이터가 들어온 것처럼 부드럽게 */
    '.hn-root .hn-bar{transition:transform 1.1s cubic-bezier(.32,.72,.28,1);}',
    '.hn-root .hn-hbar{transition:transform 1.1s cubic-bezier(.32,.72,.28,1);}',
    '.hn-root .hn-donut{transition:transform 1.6s cubic-bezier(.4,.5,.25,1);}',
    '.hn-root .hn-meterfill{transition:-webkit-mask-image .9s linear,mask-image .9s linear;}',
    '.hn-root .hn-callout{transition:transform .9s cubic-bezier(.32,.72,.28,1);}',
    /* 이벤트 피드 새 줄 */
    '.hn-root .hn-newrow{animation:hnRow .55s cubic-bezier(.22,.9,.24,1);}',
    '@keyframes hnRow{0%{opacity:0;transform:translateY(-6px)}100%{opacity:1;transform:none}}',
    ...
    '.hn-root [data-name="Menu/Dropdown"]{z-index:60;}',
    '.hn-root [data-name="Menu/Dropdown"] [data-name^="Menu Item/"]{'
    + 'transition:background-color .18s ease,border-color .18s ease,box-shadow .18s ease;}',
    '.hn-root [data-name="Menu/Dropdown"] [data-name^="Menu Item/"]:not(.hn-off):hover{'
    + 'background-color:rgba(0,84,169,0.3);border-color:#2861ff;'
    + 'box-shadow:inset 0px 0px 13px 0px rgba(1,53,201,0.7);}',
    '.hn-root [data-name="Menu/Dropdown"] [data-name^="Menu Item/"]:not(.hn-off):hover p{color:#fff;}',
    /* 드롭다운은 위의 선택 모습으로 반응하므로 공통 흰색 틴트는 끈다 */
    '.hn-root [data-name="Menu/Dropdown"] .hn-hot::before{display:none;}',
    /* 지금 보고 있는 화면의 항목 — 원본의 '선택됨' 모습 그대로.
       옮겨 심은 드롭다운은 메인 화면 것이라 선택 표시가 '하차현황'에 박혀 있어서 여기로 옮겨 준다. */
    '.hn-root [data-name="Menu/Dropdown"] .hn-cur{'
    + 'background-color:rgba(0,84,169,0.3);border-color:#2861ff;'
    + 'box-shadow:inset 0px 0px 13px 0px rgba(1,53,201,0.7);}',
    '.hn-root [data-name="Menu/Dropdown"] .hn-cur p{color:#fff;}',
    /* 박제된 선택 표시를 되돌린 항목 — 판·테두리·글자를 '기본' 항목과 같게 하고 덧칠 레이어를 감춘다 */
    '.hn-root [data-name="Menu/Dropdown"] .hn-uncur{'
    + 'background-color:#222737;border-color:#3f4656;box-shadow:none;}',
    '.hn-root [data-name="Menu/Dropdown"] .hn-uncur p{color:#ccc;}',
    '.hn-root [data-name="Menu/Dropdown"] .hn-uncur > div:empty{display:none;}',
    /* 라이트에서는 값을 그대로 쓰면 안 된다 — 위 색은 어두운 판 전제다.
       생성기(light.js)가 같은 자리에 내는 값과 똑같이 맞춘다(선택 #517aec/파란 틴트/어두운 글자,
       기본 #eef1f8/#d1d7e4/#3f4859). */
    '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] [data-name^="Menu Item/"]:not(.hn-off):hover,'
    + '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] .hn-cur{'
    + 'background-color:rgba(40,97,255,0.18);border-color:#517aec;'
    + 'box-shadow:inset 0px 0px 13px 0px rgba(1,53,201,0.35);}',
    '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] [data-name^="Menu Item/"]:not(.hn-off):hover p,'
    + '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] .hn-cur p{color:#141a28;}',
    '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] .hn-uncur{'
    + 'background-color:#eef1f8;border-color:#d1d7e4;box-shadow:none;}',
    '.hn-root[data-theme="light"] [data-name="Menu/Dropdown"] .hn-uncur p{color:#3f4859;}',
    /* 아직 시안이 없어 갈 수 없는 항목 — 가만히 있을 때의 그림은 원본 그대로 두고
       (메인 화면은 원본과 픽셀 동일해야 한다) 마우스를 올렸을 때만 '못 간다'고 알린다. */
    '.hn-root .hn-off{cursor:not-allowed;transition:opacity .18s ease;}',
    '.hn-root .hn-off::before{display:none!important;}',
    '.hn-root .hn-off:hover{opacity:.5;}',
    /* 도크 슬롯 호버는 살짝 떠오르게 */
    '.hn-root .hn-hot.hn-slot{transition:filter .18s ease;}',
    '.hn-root .hn-hot.hn-slot:hover{filter:brightness(1.14);}',
    '.hn-root[data-theme="light"] .hn-hot.hn-slot:hover{filter:brightness(.94) saturate(1.1);}',
    /* 네모 판이 없는 것들(핀·색점·라디오처럼 그림만 있는 자리)은 사각형 틴트를 씌우면
       그림 밖까지 네모나게 칠해지고 모서리에서 잘려 보인다 → 밝기로만 반응한다. */
    '.hn-root .hn-hot.hn-soft::before{display:none;}',
    '.hn-root .hn-hot.hn-soft{transition:filter .18s ease;}',
    '.hn-root .hn-hot.hn-soft:hover{filter:brightness(1.35) saturate(1.1);}',
    '.hn-root .hn-hot.hn-soft:active{filter:brightness(1.6) saturate(1.15);}',
    '.hn-root[data-theme="light"] .hn-hot.hn-soft:hover{filter:brightness(.86) saturate(1.15);}',
    '.hn-root[data-theme="light"] .hn-hot.hn-soft:active{filter:brightness(.74) saturate(1.2);}',
    /* 검색창 — 원본 <p> 를 그대로 칠 수 있게 만든다. 빈칸일 때만 원본의 안내 문구를 그린다
       (::before 라 글꼴·자간·색이 원본 그대로다). */
    '.hn-root .hn-input{outline:none;min-width:4px;cursor:text;white-space:pre;}',
    '.hn-root .hn-input:empty::before{content:attr(data-hn-hint);}',
    '.hn-root .hn-searchbox{transition:box-shadow .18s ease;}',
    '.hn-root .hn-searchbox.hn-on{box-shadow:0 0 0 1px rgba(40,97,255,.85);}',
    '.hn-root .hn-searchbox.hn-nohit{box-shadow:0 0 0 1px rgba(244,54,121,.85);}',
    /* 검색 결과 — 맞는 것만 남기고 나머지는 뒤로 물린다 */
    '.hn-root .hn-dim{opacity:.2;transition:opacity .22s ease;}',
    '.hn-root .hn-find{animation:hnFind 1.2s ease-out 2;}',
    '@keyframes hnFind{0%,100%{filter:none}50%{filter:brightness(1.45) drop-shadow(0 0 7px rgba(64,150,255,.95))}}',
    /* 프로토타입 상태 전환 — 갈아 끼울 때 톡 튀지 않게 */
    '.hn-root [data-hn-vset]{transition:opacity .22s ease;}',
    ...
    '@media (prefers-reduced-motion:reduce){.hn-root *{animation-duration:.001s!important;transition-duration:.001s!important;}}',
  ].join('\n');
  ...
  function setNum(el, v, srcText) {
    ...
    el.textContent = next;
    el.classList.remove('hn-tick');
    void el.offsetWidth;                       /* 애니메이션 재시작 */
    el.classList.add('hn-tick');
  }
  ...
  function unhideVariants(root) {
    var kept = [];
    all(root, '[data-hn-vset][hidden], [data-hn-graft][hidden]').forEach(function (el) {
  ...
  function swapNodeClass(a, b) {
    ...
    a.classList.add('hn-swap'); b.classList.add('hn-swap');
  }
  ...
  /* ══════════════════ 4-b. 프로토타입 상태 전환(변형 세트) ══════════════════
     ...
     conv.js 가 그 상태들을 전부 심어 두고 하나만 보이게 해 두었으므로(data-hn-vset/​-variant),
     여기서는 '어느 것을 보일지'만 바꾼다 — 색이나 테두리를 흉내 내지 않으니 원본과 어긋날 일이 없다. */
  function installVariants(root, st) {
    var sets = {};
    all(root, '[data-hn-vset]').forEach(function (el) {
      (sets[el.dataset.hnVset] || (sets[el.dataset.hnVset] = [])).push(el);
    });
    ...
    var show = function (key, value) {
      ...
      var next = list.filter(function (e) { return e.dataset.hnVariant === value; })[0];
  ...
  function installGauge(root, st) {
    ...
    fill.id = (img.id || 'hn-meter') + '-fill';
    fill.classList.add('hn-meterfill');
    ...
    if (callout) {
      callout.classList.add('hn-callout');
    ...
    var setV = function (v) {
      ...
      if (coVal) setNum(coVal, v * 100, coVal.dataset.hnSrc || (coVal.dataset.hnSrc = coVal.textContent));
      ...
      if (todayNums.length >= 2) {
        ...
        setNum(todayNums[0], Math.round(total * v), todayNums[0].dataset.hnSrc || (todayNums[0].dataset.hnSrc = todayNums[0].textContent));
        if (todayNums[2]) setNum(todayNums[2], v * 100, todayNums[2].dataset.hnSrc || (todayNums[2].dataset.hnSrc = todayNums[2].textContent));
      }
    };
    setV(v0);
    var step = function () {
  ...
  function installBars(root, st) {
    ...
    vbars.forEach(function (b) { b.classList.add('hn-bar'); b.style.transformOrigin = 'bottom center'; });
    var hbars = all(root, '[data-name="Bar Row"] [data-name="Bar"]');
    hbars.forEach(function (b) { b.classList.add('hn-hbar'); b.style.transformOrigin = 'left center'; });
  ...
  function installDonuts(root, st) {
    ...
    plots.forEach(function (p) { p.classList.add('hn-donut'); p.style.transformOrigin = '50% 50%'; });
    var step = function () {
      if (editing()) return;
  ...
  function installFeed(root, st) {
    ...
    var fill = function (row, ev) {
      ...
      row.classList.remove('hn-newrow');
      void row.offsetWidth;
      row.classList.add('hn-newrow');
    };
  ...
  function installDockTooltip(root, st) {
    ...
    slots.forEach(function (s, i) {
      if (s.dataset.hnPlate) return;
      s.dataset.hnPlate = PLATES[i % PLATES.length];
      s.dataset.hnChassis = '충남' + (10 + (i * 7) % 80) + '아' + (1000 + (i * 613) % 8000);
      s.dataset.hnNext = PLATES[(i + 2) % PLATES.length];
    });
    slots.forEach(function (s) {
      var enter = function () {
        ...
        setRow(1, s.dataset.hnPlate || '-');
        setRow(2, s.dataset.hnChassis || '-');
        setRow(3, s.dataset.hnNext || '-');
  ...
  /* ══════════════════ 6-k. 건물 조감도 — 옮겨 보고 키워 보기 ══════════════════
     통합관제 한가운데 3D 렌더(`#hn-Asset_2` = building-image.png)를 지도 다루듯 본다.
  ...
  /* ══════════════════ 6-h. 헤더 메뉴 — 화면 이동 ══════════════════
     ...
     · `통합관제` → 드롭다운 펼치기/접기. 하위 화면에는 원본에 드롭다운이 없어 conv.js 가 메인 것을
       그대로 옮겨 심어 두었다(`data-hn-graft="dropdown"`), 메인 화면 것은 원본대로 늘 펼쳐 둔다.
     · 드롭다운 항목 → 그 화면으로. 아직 시안이 없는 `상차현황`·`차량관제` 는 눌러도 안 움직인다.
     스튜디오 안에서는 window.__openHanaScreen 이, 낱장으로 열었을 때는 파일 이동이 맡는다. */
  ...
  function installMenu(root, st) {
    ...
    var dd = one(root, '[data-name="Menu/Dropdown"]');
    var graft = !!(dd && dd.dataset.hnGraft === 'dropdown');
    ...
    var tab = one(root, '[data-name^="Menu Item/Control Tower"]');
    if (tab && dd && graft) {
      tab.classList.add('hn-hot', 'hn-soft');
    ...
    if (home && cur !== 'main') {
      home.classList.add('hn-hot', 'hn-soft');
    ...
    if (!graft) return;
    var want = null;
    items.forEach(function (it) { if (it.__hnTo === cur) want = it; });
    if (!want) return;
    items.forEach(function (it) {
      var baked = (it.dataset.name || '').indexOf('(Selected)') >= 0;
      if (it === want) it.classList.add('hn-cur');
      else if (baked) it.classList.add('hn-uncur');
    });
  }
  ...
  function installSearch(root, st) {
    all(root, '[data-name="Field"]').forEach(function (field) {
      ...
      ph.dataset.hnHint = hint;
      ph.textContent = '';
      ph.classList.add('hn-input');
      ...
      field.classList.add('hn-searchbox');
      ...
      var run = function () {
        ...
        field.classList.toggle('hn-on', !!q);
        var hit = 0;
        if (rows.length) {                           /* 표 — 안 맞는 줄을 감춘다 */
          ...
          marks.forEach(function (el) {
            var hay = (el.dataset.hnPlate || '') + (el.dataset.hnChassis || '')
              + (el.textContent || '').replace(/\s/g, '');
            var ok = !q || hay.indexOf(q) >= 0;
            el.classList.toggle('hn-dim', !!q && !ok);
            if (q && ok) { hit++; el.classList.remove('hn-find'); void el.offsetWidth; el.classList.add('hn-find'); }
            else el.classList.remove('hn-find');
          });
        }
        field.classList.toggle('hn-nohit', !!q && !hit);
      };
      ...
      if (btn) { btn.classList.add('hn-hot'); btn.setAttribute('role', 'button'); btn.title = '검색'; }
      ...
      st.cleanup.push(function () {
        ...
        ph.removeAttribute('contenteditable'); ph.classList.remove('hn-input');
  ...
  function installRadioChip(root, st) {
    all(root, '[data-name="Checkbox/GS Vehicle"]').forEach(function (chip) {
      ...
      if (on === off) return;
      chip.classList.add('hn-hot', 'hn-soft');
  ...
  function installHanaLive(root, st) {
    ...
    if (nums.length) {
      ...
      st.cleanup.push(function () { clearInterval(nid); nums.forEach(function (c) { c.el.textContent = c.src; c.el.classList.remove('hn-num'); }); });
    }
  ...
  function initHana(root) {
    if (!root) return;
    if (root.__hnLive) disposeHana(root);
    injectStyle();
    root.classList.add('hn-root');
    var st = { cleanup: [] };
    root.__hnLive = st;
  ...
  function disposeHana(root) {
    var st = root && root.__hnLive;
    if (!st) return;
    st.cleanup.forEach(function (f) { try { f(); } catch (e) { } });
    root.__hnLive = null;
  }

  window.initHana = initHana;
  window.disposeHana = disposeHana;
  /* 스튜디오가 창 크기를 바꾼 뒤 다시 맞추라고 부를 수 있게 */
  window.refitHana = function (root) { var st = root && root.__hnLive; if (st && st.fit) st.fit(); };
})();
